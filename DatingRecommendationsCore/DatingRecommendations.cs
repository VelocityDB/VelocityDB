...
namespace DatingRecommendations
{
  ...
  {
    static readonly string s_systemDir = SessionBase.BaseDatabasePath + "/DatingRecommendationsCore";
    static readonly string s_inputDataDir = RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? "c:/SampleData/libimseti" : "/SampleData/libimseti"; // change if you need to, download dataset from http://www.occamslab.com/petricek/data/
