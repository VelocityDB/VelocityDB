...
namespace VelocityDBExtensions.CompressedBitArray
{
  ...
  /// patents.</p>
  /// 
  /// <para>Ported to C# by Kemal Erdogan. https://github.com/lemire/csharpewah </para>
  /// </summary>
  [Serializable]
  public sealed class EwahCompressedBitArray : OptimizedPersistable, ICloneable, IEnumerable<int>
  {
    /// <summary>
