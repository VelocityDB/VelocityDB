...
namespace FacebookGraph
{
  class FacebookGraph
  {
    static readonly string s_systemDir = "FacebookGraphCore";
    static readonly string s_inputData = RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? "c:/SampleData/bfs-28-socialgraph-release-corrected" : "c:/SampleData/bfs-28-socialgraph-release-corrected"; // change if you need to, download dataset from http://www.VelocityDB.com/Public/bfs-28-socialgraph-release-corrected.zip (and uncompress with 7-zip http://www.7-zip.org/)
